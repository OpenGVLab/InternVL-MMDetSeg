...
class DINOHead(DeformableDETRHead):
    ...
    def forward_train(self,
        ...
        self.label_embedding = self.label_embedding.float()
    ...
    def forward(self,
        ...
        # this part is added to deal with deepspeed fp16
        self.cls_branches = self.cls_branches.to(torch.float32)
        self.reg_branches = self.reg_branches.to(torch.float32)
        ...
        for feat in mlvl_feats:
            ...
            mlvl_positional_encodings.append(
                self.positional_encoding(mlvl_masks[-1]).to(mlvl_feats[-1].dtype))
        ...
        inter_references = inter_references.float()
        hs = hs.float()
        ...
        return outputs_classes.float(), outputs_coords.float(), topk_score.float(), topk_anchor.float()
    ...
    def loss_dn_single(self, dn_cls_scores, dn_bbox_preds, gt_bboxes_list,
        ...
        print("cls_scores:", cls_scores.dtype)
        ...
        print("bbox_preds:", bbox_preds.dtype)
